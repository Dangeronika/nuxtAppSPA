  ...
  <div>
    <header>
      <div class="top-line">
        ...
        <div class="top top-right-element">
...
export default {
  ...
  data () {
    return {
      ...
      todo_selected: false,
      index_href_selected: false,
      map_href_selected: false,
      timer_href_selected: false,
      todo_href_selected: false
    }
  },
  mounted () {
...
/* Конец header-top части */

/* Начало header-bottom части */
